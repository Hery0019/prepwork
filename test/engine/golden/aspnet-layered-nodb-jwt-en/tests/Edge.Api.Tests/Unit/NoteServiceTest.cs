...
namespace Edge.Api.Tests.Unit;

// Unit level (CORE-020): no host, no database. The port is a test double and the clock
// is fixed, so the test is deterministic and runs in milliseconds.
[Trait("Category", "Unit")]
