...
|---|---|---|
| `domain` | `BackOffice.Domain` | rien |
| `application` | `BackOffice.Application` | `domain` |
| `infrastructure` | `BackOffice.Infrastructure` | `application`, `domain` |
| `api` | `BackOffice.Api` | `application`, `domain`, `infrastructure` |
...
- `src/BackOffice.Domain/Notes/Note.cs`
- `src/BackOffice.Application/Notes/INoteRepository.cs`
- `src/BackOffice.Application/Notes/NoteView.cs`
- `src/BackOffice.Application/Notes/NoteService.cs`
- `src/BackOffice.Infrastructure/Notes/NoteRepository.cs`
- `src/BackOffice.Api/Notes/NotesController.cs`
- `src/BackOffice.Api/Notes/CreateNoteRequest.cs`
- `tests/BackOffice.Tests/Unit/NoteServiceTest.cs`
- `tests/BackOffice.Tests/Slice/NotesControllerTest.cs`
- `tests/BackOffice.Tests/Integration/NotesApiTest.cs`
...
| Projet | Référence |
|---|---|
| `BackOffice.Domain` | aucune |
| `BackOffice.Application` | `BackOffice.Domain` |
| `BackOffice.Infrastructure` | `BackOffice.Application`, `BackOffice.Domain` |
| `BackOffice.Api` | `BackOffice.Application`, `BackOffice.Domain`, `BackOffice.Infrastructure` |
| `BackOffice.Tests` | `BackOffice.Api`, `BackOffice.Application`, `BackOffice.Domain`, `BackOffice.Infrastructure` |
