...
| `src/BackOffice.Domain/` | Projet `domain` |
| `src/BackOffice.Application/` | Projet `application` |
| `src/BackOffice.Infrastructure/` | Projet `infrastructure` |
| `src/BackOffice.Api/` | Projet `api` |
| `tests/BackOffice.Tests/` | Projet `tests` |
