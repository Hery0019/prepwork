...
public sealed class CoreArchitectureTest
{
    ...
    [
        Assembly.Load("BackOffice.Domain"),
        Assembly.Load("BackOffice.Application"),
        Assembly.Load("BackOffice.Infrastructure"),
        Assembly.Load("BackOffice.Api"),
        Assembly.Load("BackOffice.Tests"),
    ];
