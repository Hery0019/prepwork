...
|---|---|---|
| `domain` | `back_office.domain` | rien |
| `repository` | `back_office.repository` | `domain` |
| `service` | `back_office.service` | `repository`, `domain` |
| `api` | `back_office.api` | `service`, `domain` |
...
- `src/back_office/domain/note.py`
- `src/back_office/repository/note_repository.py`
- `src/back_office/service/note_service.py`
- `src/back_office/api/notes.py`
- `src/back_office/api/schemas/note.py`
