...
/**
 * Règles du profil layered. Chaque règle porte l'identifiant LAY qu'elle outille ; la règle LAY_009 est construite depuis les couches déclarées dans le profil.
 */
...
class LayeredArchitectureTest {
    ...
    private static final String WEB = "mg.solumada.payflow.web..";
    private static final String SERVICE = "mg.solumada.payflow.service..";
    private static final String REPOSITORY = "mg.solumada.payflow.repository..";
    private static final String DOMAIN = "mg.solumada.payflow.domain..";
