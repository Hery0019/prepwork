...
- **MOD-007** · guidance — La façade de service à la racine du module renvoie des records publics, jamais l'entité interne.
  Pourquoi : Une entité renvoyée par la façade devient de fait l'API publique du module.
