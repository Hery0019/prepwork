...
| Profil d'architecture | `modular` — Monolithe modulaire avec Spring Modulith, un module par domaine métier, communication par événements. |
...
Un skill par sujet. Chaque règle y porte un identifiant stable (`MOD-002`) à citer dans les plans et les revues.
