...
/**
 * Niveau intégration (CORE-020) : contexte complet et vraie base via Testcontainers (CORE-021). Vérifie aussi que l'événement NoteCreated traverse la frontière de module (MOD-005).
 */
@SpringBootTest
