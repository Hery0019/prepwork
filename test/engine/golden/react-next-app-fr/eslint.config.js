...
// renvoie au skill `architecture` (NEXT-002 à NEXT-009).
...
export default tseslint.config(
  { ignores: ['.next', 'next-env.d.ts', 'coverage', 'playwright-report', 'test-results', 'public'] },
    ...
    rules: {
      ...
      'boundaries/element-types': [
        'error',
        {
          default: 'disallow',
          message:
            'NEXT-006 / NEXT-008 : ${file.type} ne peut pas importer ${dependency.type} (voir le skill architecture).',
          rules: [
      ...
      // NEXT-002, NEXT-007 : on n'importe que l'index public d'une feature ou d'une entité.
      'boundaries/entry-point': [
        'error',
        {
          default: 'disallow',
          message:
            "NEXT-007 : seul l'index public d'une couche est importable ; ${dependency.source} est un fichier interne.",
          rules: [
      ...
      // NEXT-AP-002 : pas de dépôt fourre-tout ; NEXT-007 : pas d'import profond dans une feature.
          ...
          patterns: [
            {
              ...
              message:
                "NEXT-AP-002 : nommer le module par ce qu'il fait, dans `shared/lib` ou dans la feature.",
            },
            {
              group: ['**/features/*/*', '**/entities/*/*'],
              message:
                "NEXT-007 : passer par l'index public de la feature ou de l'entité (SPA-003).",
            },
          ],
        },
      ],
