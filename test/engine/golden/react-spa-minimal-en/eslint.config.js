// ESLint enforces the boundaries between layers and the checkable markup rules.
// Every boundary rule carries the identifier of the profile rule: the error message points
// back to the `architecture` skill (SPA-001 to SPA-012).
