// Project button. Copied into the repository, so editable: that is the point of shadcn.
// CORE-011: the disabled state and the focus ring belong to the component, not to the caller.
